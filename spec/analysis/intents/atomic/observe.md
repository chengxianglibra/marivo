...
- `resolved_policy_summary.bucket_pairing` 在 v1 仅作为该 observation artifact 的 frozen metadata 明细存在，不生成独立 artifact 或 typed ref；如需治理结论，见 `spec/semantic/calendar-bucket-pairing-artifact-decision.zh.md`
