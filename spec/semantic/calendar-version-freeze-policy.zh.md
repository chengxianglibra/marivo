...
- `spec/semantic/calendar-annotation-failure-policy.zh.md`
...
更细的 annotation 缺失、holiday/event unmapped 与 coverage 问题，见 `spec/semantic/calendar-annotation-failure-policy.zh.md`。
