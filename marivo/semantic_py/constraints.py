"""Constraint catalog for ``marivo.semantic_py`` authoring and validation.
...
class ConstraintId(StrEnum):
    """Stable identifiers for semantic_py constraints."""
...
_EXAMPLE_BASE = "marivo-skill/marivo-py-semantic/references/examples"
...
CONSTRAINTS: dict[ConstraintId, Constraint] = {
    ...
    ConstraintId.UNIQUE_SEMANTIC_NAME: _constraint(
        ...
        docs_ref="marivo-skill/marivo-py-semantic/references/cheatsheet.md",
    ),
    ...
    ConstraintId.HOUR_TIME_FIELD_PREFIX: _constraint(
        ...
        docs_ref="marivo-skill/marivo-py-semantic/references/time-field-patterns.md",
    ),
    ...
    ConstraintId.PROVENANCE_VERIFIED: _constraint(
        ...
        "Run project.parity_check(...) or semantic_py check --parity.",
    ),
