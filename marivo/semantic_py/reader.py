"""SemanticProject reader API for marivo.semantic_py v1.1.
...
from marivo.semantic_py.loader import LoadResult, load_project
from marivo.semantic_py.materializer import DatasetRuntimeMetadata, Materializer
from marivo.semantic_py.parity import ParityResult, parity_check, propagated_parity_status
...
class SemanticProject:
    ...
    def parity_check(
        ...
        *,
        ...
        See :func:`marivo.semantic_py.parity.parity_check` for details.
        """
        return parity_check(
            self,
            name,
