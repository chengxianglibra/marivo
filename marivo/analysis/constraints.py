...
CONSTRAINTS: dict[ConstraintId, Constraint] = {
    ...
    ConstraintId.FRAME_META_INVALID: _constraint(
        ...
        "Read the Location line on this error against the current schema, or inspect the artifact's meta.json on disk, then re-run the producing intent or delete the stale artifact so it is regenerated.",
        help_target="artifacts",
    ),
