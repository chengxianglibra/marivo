...
from marivo.analysis.errors import FollowupGenerationRuleViolatedError
from marivo.analysis.evidence.identity import make_action_id
    ...
    if issue.kind == "comparability_incompatible":
        return [
            FollowupAction(
                ...
                operator="compare",
                input_refs=[source_artifact_id],
                params={"alignment": "window_bucket"},
                category="quality_remediation",
                source_issue_id=issue.issue_id,
