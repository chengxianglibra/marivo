...
def _dimension(axis: TargetDimensionContract | None, entity: str) -> bool:
    ...
    for root in roots:
        ...
        if isinstance(payload, PopulationPayload):
            ...
            if (
                ...
                or not _dimension(definition.reference_axis, entity.ref.path)
                or not all(_dimension(axis, entity.ref.path) for axis in definition.dimensions)
            ):
                return False
