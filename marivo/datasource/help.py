    ...
    return Descriptor(
        ...
        doc="\n".join(
            (
                ...
                "10. md.raw_sql(ref, sql, reason=..., timeout_seconds=30) is the sole",
                "   terminal raw SQL execution path. It is read-only, timeout-bounded,",
                "   and row-bounded. A returned-row limit does not bound backend work.",
                "   The result is terminal custom analysis — it cannot re-enter typed",
                "   analysis. Use frame.to_pandas() for terminal pandas export from",
                "   typed analysis artifacts.",
                "",
