...
CONSTRAINTS: dict[ConstraintId, Constraint] = {
    ...
    ConstraintId.DATASOURCE_UNIQUE_NAME: _constraint(
        ...
        "DatasourceDuplicate",
        "assembly",
        (*SUPPORTED_BACKEND_TYPES, "load_datasources", "register", "remove"),
        "Datasource names must be unique; default is reserved and cannot be replaced or removed.",
        "Duplicate project-level datasource ids make source references ambiguous.",
        "Rename conflicting declarations. Use ms.ref.datasource('default') directly for built-in in-memory DuckDB.",
    ),
