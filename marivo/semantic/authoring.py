...
def _compute_composition_hash(composition: Composition) -> str:
    if isinstance(composition, RatioComposition):
        ...
        # v1 all_history is the 4th tuple element as the string 'all_history'
        # — byte-identical before and after V2. New anchors carry their
        # payload tuple, which repr encodes distinctly.
