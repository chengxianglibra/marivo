...
_SUMMARIES: dict[str, str] = {
    ...
    "EvidenceFact": "a single observed authoring fact",
    ...
    "SemanticProject": "internal project reader — agents should use ms.load() instead",
    ...
    "SemanticKind": "semantic kind enum: model, datasource, dataset, field, time_field, metric, relationship",
    ...
    "DatasetDetails": "kind-specific details for a dataset object",
    "MetricDetails": "kind-specific details for a metric object including decomposition and parity",
    "FieldDetails": "kind-specific details for a dimension or measure field",
    "TimeFieldDetails": "kind-specific details for a time field including granularity and format",
    "RelationshipDetails": "kind-specific details for a relationship between datasets",
    "ModelDetails": "kind-specific details for a model including child datasets and metrics",
