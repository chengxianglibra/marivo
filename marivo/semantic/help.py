...
_SUMMARIES: dict[str, str] = {
    ...
    "AuthoringAssessment": "composed authoring assessment returned by assess_authoring",
    "AuthoringSourceInput": "physical source role used by assess_authoring",
    ...
    "ReadinessInputSummary": "datasources, refs, tables, and decision records used by readiness",
    "RichnessSummary": "richness gap ids folded into readiness warnings",
