...
_SUMMARIES: dict[str, str] = {
    ...
    "ColumnContext": "sampled detail for one inspected datasource column",
    ...
    "SemanticProject": "internal — for authoring only; use ms.load() for reading",
    ...
    "TableContext": "basic metadata for one inspected datasource table or file",
