...
| ---------------- | --------------- |
| `validate` | `metric`, `current: { time_scope, filter? }`, `baseline: { time_scope, filter? }`, `grain: TimeGranularity`, `hypothesis: Hypothesis` |
