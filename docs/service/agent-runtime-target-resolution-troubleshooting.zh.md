...
总体模型见 [`agent-runtime-target-resolution.md`](./agent-runtime-target-resolution.md)。配置语义见 [`agent-runtime-target-resolution-config-contract.zh.md`](./agent-runtime-target-resolution-config-contract.zh.md)。错误结构见 [`agent-runtime-target-resolution-error-taxonomy.zh.md`](./agent-runtime-target-resolution-error-taxonomy.zh.md)。HTTP MCP 边界见 [`agent-runtime-target-resolution-http-mcp-boundary.zh.md`](./agent-runtime-target-resolution-http-mcp-boundary.zh.md)。
...
`runtime.json` 是本地 runtime 发现契约，不是用户编辑入口。它至少应能说明当前本地 runtime 的 `base_url`、`pid`、`workspace_root`、`config_path` 和 `metadata_path`。字段级 schema 见 [`agent-runtime-target-resolution-runtime-manifest-schema.zh.md`](./agent-runtime-target-resolution-runtime-manifest-schema.zh.md)。
...
| 问题 | 文档 |
|------|------|
| 用户接入模型与本地/远程边界 | [`agent-runtime-target-resolution.md`](./agent-runtime-target-resolution.md) |
| mode、环境变量、冲突处理 | [`agent-runtime-target-resolution-config-contract.zh.md`](./agent-runtime-target-resolution-config-contract.zh.md) |
| workspace root 解析优先级 | [`agent-runtime-target-resolution-workspace-root.zh.md`](./agent-runtime-target-resolution-workspace-root.zh.md) |
| `.marivo/` 文件布局 | [`agent-runtime-target-resolution-workspace-layout.zh.md`](./agent-runtime-target-resolution-workspace-layout.zh.md) |
| `runtime.json` 字段 | [`agent-runtime-target-resolution-runtime-manifest-schema.zh.md`](./agent-runtime-target-resolution-runtime-manifest-schema.zh.md) |
| `marivo` CLI 命令、退出码 | [`agent-runtime-target-resolution-cli-contract.zh.md`](./agent-runtime-target-resolution-cli-contract.zh.md) |
| 错误码与 detail 字段 | [`agent-runtime-target-resolution-error-taxonomy.zh.md`](./agent-runtime-target-resolution-error-taxonomy.zh.md) |
| HTTP MCP 本地托管限制 | [`agent-runtime-target-resolution-http-mcp-boundary.zh.md`](./agent-runtime-target-resolution-http-mcp-boundary.zh.md) |
