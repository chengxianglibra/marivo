...
本文档定义 Marivo 在 `docs/analysis/` 语境下的 agent interaction contract（Agent 交互分析接口）设计准则。
...
本文的目标，是为 `docs/analysis/` 下的 typed intent、canonical evidence schema 与 projection 设计提供一组统一准则，使 Marivo 面向 agent 的交互接口始终保持：
