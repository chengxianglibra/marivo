...
> Marivo 的 metric v2 应以 typed measurement contract 为中心，显式表达 observed entity、observation grain、sample kind、family-specific measurement payload、additivity、comparability 与 required process contract，并把过程构造与执行细节下沉到 process object 和 compiler / IR。
