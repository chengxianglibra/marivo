...
- `docs/semantic/calendar-annotation-generation-policy.zh.md`
...
更完整的 version freeze 规则、publish workflow 与 rollback 边界，见 `docs/semantic/calendar-version-freeze-policy.zh.md`。
