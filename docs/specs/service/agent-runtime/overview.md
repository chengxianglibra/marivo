...
v1 产品边界与用户心智模型已冻结，见 [`scope-note.zh.md`](./scope-note.zh.md)。v1 配置语义与解析规则已冻结，见 [`config-contract.zh.md`](./config-contract.zh.md)。v1 workspace root 解析优先级已冻结，见 [`workspace-root.zh.md`](./workspace-root.zh.md)。v1 失败面 taxonomy 已冻结，见 [`error-taxonomy.zh.md`](./error-taxonomy.zh.md)。v1 HTTP MCP 适用边界已冻结，见 [`http-mcp-boundary.zh.md`](./http-mcp-boundary.zh.md)。v1 `marivo core` CLI 命令面已冻结，见 [`cli-contract.zh.md`](./cli-contract.zh.md)。v1 工作区 `.marivo/` 布局已冻结，见 [`workspace-layout.zh.md`](./workspace-layout.zh.md)。v1 最小本地配置 bootstrap 已冻结，见 [`bootstrap-config.zh.md`](./bootstrap-config.zh.md)。
...
本地模式在常见路径上应做到零配置。首次启动时，Marivo 应落地一份最小的工作区本地配置。最小配置已冻结，见 [`bootstrap-config.zh.md`](./bootstrap-config.zh.md)。
...
该默认配置只覆盖本地自动托管路径。生产级共享 metadata store 的 MySQL Fresh-init v1 边界见 [`fresh-init-v1.zh.md`](../mysql-metadata/fresh-init-v1.zh.md)；MySQL metadata 是 control-plane 存储选择，不是 source adapter 或 execution engine。
...
用户与 operator 的最小排障路径见 [`troubleshooting.zh.md`](./troubleshooting.zh.md)。
