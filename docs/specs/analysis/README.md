...
- 原子工件（artifact）的 subtype 由 artifact 本体上的 discriminator 决定，例如 `metric_frame.shape`、`delta_frame.shape`、`decomposition_type`、`artifact_type = “anomaly_candidates”`、`result_type = “hypothesis_test”`、`observation_type = “forecast_series”`
