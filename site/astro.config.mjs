      ...
      sidebar: [
        {
          ...
          items: docsItems('latest', ['0.4.1', '0.4.0', '0.3.3', '0.3.2', '0.3.1', '0.3.0', '0.2.8', '0.2.7', '0.2.6', '0.2.5', '0.2.4', '0.2.3', '0.2.2', '0.2.1', '0.2.0', '0.1.0'], true),
        },
        {
          label: 'v0.4',
          items: docsItems('v0.4', ['0.4.1', '0.4.0', '0.3.3', '0.3.2', '0.3.1', '0.3.0', '0.2.8', '0.2.7', '0.2.6', '0.2.5', '0.2.4', '0.2.3', '0.2.2', '0.2.1', '0.2.0', '0.1.0']),
          collapsed: true,
        },
        {
          label: 'v0.3',
