      ...
      sidebar: [
        {
          ...
          items: docsItems('latest', ['0.5.3', '0.5.2', '0.5.1', '0.5.0', '0.4.16', '0.4.15', '0.4.14', '0.4.13', '0.4.12', '0.4.11', '0.4.10', '0.4.9', '0.4.8', '0.4.7', '0.4.6', '0.4.5', '0.4.4', '0.4.3', '0.4.2', '0.4.1', '0.4.0', '0.3.3', '0.3.2', '0.3.1', '0.3.0', '0.2.8', '0.2.7', '0.2.6', '0.2.5', '0.2.4', '0.2.3', '0.2.2', '0.2.1', '0.2.0', '0.1.0'], true),
        },
        {
          label: 'v0.5',
          items: docsItems('v0.5', ['0.5.3', '0.5.2', '0.5.1', '0.5.0']),
          collapsed: true,
        },
        {
          label: 'v0.4',
