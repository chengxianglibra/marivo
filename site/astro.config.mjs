      ...
      sidebar: [
        {
          ...
          items: docsItems('latest', ['0.2.7', '0.2.6', '0.2.5', '0.2.4', '0.2.3', '0.2.2', '0.2.1', '0.2.0', '0.1.0']),
        },
        {
          label: 'v0.2',
          items: docsItems('v0.2', ['0.2.7', '0.2.6', '0.2.5', '0.2.4', '0.2.3', '0.2.2', '0.2.1', '0.2.0', '0.1.0']),
          collapsed: true,
        },
        {
          label: 'v0.1',
