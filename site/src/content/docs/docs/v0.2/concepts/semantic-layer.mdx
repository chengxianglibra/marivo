---
slug: docs/v0.2/concepts/semantic-layer
...
For how readiness decides what is "ready," see [Readiness](/docs/v0.2/concepts/readiness/).
For how analysis records what it concludes, see [Evidence](/docs/v0.2/concepts/evidence/).
Then continue to the [Analysis Workflow](/docs/v0.2/concepts/analysis-workflow/).
