---
slug: docs/v0.3/concepts/readiness
title: Readiness
...
Optional enrichment gaps, such as missing `ai_context.guardrails`, are reported
by `ms.richness()`. They do not change readiness status.
...
concludes, see [Evidence](/docs/v0.3/concepts/evidence/).
