---
slug: docs/v0.1/contributing
title: Contributing
description: Set up Marivo locally and run the repository checks before opening a pull request.
---

Read `AGENTS.md` before contributing code in this repository. It is the source of stable coding, testing, and documentation rules.
