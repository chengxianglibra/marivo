---
slug: docs/v0.1/concepts/semantic-layer
...
Every semantic object accepts an optional `ai_context` dict. This is where business
...
For how readiness decides what is "ready," see [Readiness](/docs/v0.1/concepts/readiness/).
For how analysis records what it concludes, see [Evidence](/docs/v0.1/concepts/evidence/).
Then continue to the [Analysis Workflow](/docs/v0.1/concepts/analysis-workflow/).
