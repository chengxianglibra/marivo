---
slug: docs/v0.1/concepts/analysis-workflow
...
readiness blockers in the [semantic layer](/docs/v0.1/concepts/semantic-layer/)
before observing.
:::
...
| dimension input | `catalog.get("sales.orders.region")` | A catalog dimension object or its `DimensionRef` / `TimeDimensionRef` (see [Semantic refs](/docs/v0.1/concepts/semantic-layer/#semantic-refs)). Used for `dimensions`, `where` keys, and `axis`. |
...
See [Evidence](/docs/v0.1/concepts/evidence/) for the full model.
