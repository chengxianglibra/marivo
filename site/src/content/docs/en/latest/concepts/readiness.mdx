...
Readiness is the zero-query gate between authoring and analysis. It consumes
fresh static verification and scoped runtime-preview evidence for the dependency
closure and returns a `ReadinessReport`.
