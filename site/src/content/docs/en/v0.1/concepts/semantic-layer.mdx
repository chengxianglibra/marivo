---
slug: en/v0.1/concepts/semantic-layer
...
For how readiness decides what is "ready," see [Readiness](/en/v0.1/concepts/readiness/).
For how analysis records what it concludes, see [Evidence](/en/v0.1/concepts/evidence/).
Then continue to the [Analysis Workflow](/en/v0.1/concepts/analysis-workflow/).
