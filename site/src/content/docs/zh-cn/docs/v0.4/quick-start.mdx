---
slug: zh-cn/docs/v0.4/quick-start
title: 快速开始
...
4. catalog 能加载且没有 semantic gap 时，直接进入[第一次分析](/zh-cn/docs/latest/first-analysis/)。
...
完成[安装](/zh-cn/docs/v0.4/installation/)，然后告诉智能体数据源、业务目标和已经确定的规则：
...
重跑。确认后继续[让智能体完成第一次分析](/zh-cn/docs/latest/first-analysis/)。
