...
def test_expression_single_dialect():
    from app.api.models.osi import DialectExpression, Expression
...
def test_field_minimal():
    from app.api.models.osi import DialectExpression, Expression, Field
...
def test_field_with_dimension_is_time():
    from app.api.models.osi import DialectExpression, Dimension, Expression, Field
...
def test_metric_minimal():
    from app.api.models.osi import DialectExpression, Expression, Metric
