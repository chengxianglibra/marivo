...
def _bootstrap_sales(tmp_path):
    ...
    (semantic_dir / "datasets.py").write_text(
        ...
        "\n"
        "@ms.dimension(name='user_region', dataset=users)\n"
        ...
        ")\n"
        "\n"
        "@ms.metric(datasets=[orders, users], root_dataset=orders, additivity='additive', decomposition=ms.sum(), verification_mode='python_native',)\n"
