...
class UIBothEnabledTests(unittest.TestCase):
    ...
    def test_admin_css_declares_semantic_readiness_states(self) -> None:
        resp = self.client.get("/static/admin.css")
        self.assertIn(".semantic-filter-stack", resp.text)
        self.assertIn(".semantic-readiness-chip", resp.text)
        self.assertIn(".semantic-blocker-list", resp.text)
        self.assertIn(".semantic-blocker-item", resp.text)
    ...
    def test_admin_data_sources_declares_t4_client_helpers_and_modals(self) -> None:
        ...
        self.assertIn("let tableRequestVersion = 0", resp.text)
        self.assertIn("const requestVersion = ++tableRequestVersion", resp.text)
    ...
    def test_admin_semantic_catalog_declares_t7_object_page_contracts(self) -> None:
        ...
        self.assertIn("Summary", module_resp.text)
        self.assertIn("Readiness", module_resp.text)
        self.assertIn("Blocking Requirements", module_resp.text)
        self.assertIn("Dependencies", module_resp.text)
        self.assertIn("Dependents", module_resp.text)
        self.assertIn("Capabilities", module_resp.text)
        self.assertIn("Interface / Payload Summary", module_resp.text)
        self.assertIn("Relationship Summary", module_resp.text)
        self.assertIn("Lifecycle", module_resp.text)
        ...
        self.assertIn("lifecycle", module_resp.text)
        self.assertIn("readiness", module_resp.text)
        self.assertIn("blockers", module_resp.text)
        self.assertIn("revision", module_resp.text)
        self.assertIn("updated_at", module_resp.text)
        self.assertIn("All lifecycle", module_resp.text)
        self.assertIn("All readiness", module_resp.text)
        self.assertIn("All blocker states", module_resp.text)
        self.assertIn("Draft", module_resp.text)
        self.assertIn("Active", module_resp.text)
        self.assertIn("Not Ready", module_resp.text)
        self.assertIn("Stale", module_resp.text)
