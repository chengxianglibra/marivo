"""Tests for marivo.semantic_py reader API — list/search/lineage/describe/compile_sql.
...
from marivo.semantic_py.errors import ErrorKind, SemanticLoadFailed, SemanticRuntimeError
