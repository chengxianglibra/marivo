...
def test_actual_process_crashes_reconcile_without_replaying_the_source(tmp_path: Path) -> None:
    ...
    for point in CRASH_POINTS:
        ...
        assert (
            construction_stats["primary_queries"] == construction_stats["validation_queries"] == 0
        )
