...
- **Deterministic evidence packaging** that converts SQL results into:
  ...
  - recommendations with priority/risk/impact and `causal_basis` metadata (inference level, confounders, suggested validation), generated only during final synthesis from confirmed claims
